...
import { buildBlogPostingJsonLd, buildBreadcrumbJsonLd } from "../utils/seoSchemas";
        ...
        <>
            <SEO
                ...
                jsonLd={{
                    ...
                    "@graph": [
                        buildBlogPostingJsonLd(post, isPortuguese),
                        buildBreadcrumbJsonLd([
                            { name: lang === "en" ? "Home" : "Início", path: "/" },
                            { name: lang === "en" ? "Blog" : "Blog", path: blogBasePath },
                            { name: activeTitle, path: postPath(post) },
                        ]),
                    ],
                }}
            />
